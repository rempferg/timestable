...
@Component({
  selector: 'app-plustable-equations-page',
  standalone: true,
  imports: [LearningMenubarComponent, PlusTableEquationsComponent],
  templateUrl: './plustable-equations-page.component.html',
  styleUrl: './plustable-equations-page.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PlustableEquationsPageComponent implements OnInit {
