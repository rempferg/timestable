...
@Component({
  selector: 'app-answer-dialog-plus-equations',
  standalone: true,
  templateUrl: './answer-dialog-plus-equations.component.html',
  styleUrl: './answer-dialog-plus-equations.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AnswerDialogPlusEquationsComponent implements OnInit, OnDestroy {
