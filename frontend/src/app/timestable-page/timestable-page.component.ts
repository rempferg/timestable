...
@Component({
  selector: 'app-timestable-page',
  standalone: true,
  imports: [LearningMenubarComponent, TimesTableComponent],
  templateUrl: './timestable-page.component.html',
  styleUrl: './timestable-page.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TimestablePageComponent implements OnInit {
