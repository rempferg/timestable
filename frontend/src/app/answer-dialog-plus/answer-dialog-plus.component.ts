...
@Component({
  selector: 'app-answer-dialog-plus',
  standalone: true,
  templateUrl: './answer-dialog-plus.component.html',
  styleUrl: './answer-dialog-plus.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AnswerDialogPlusComponent implements OnInit, OnDestroy {
